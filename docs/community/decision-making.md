...
## 협력적 의사결정의 요소 & 디자인
시간이 많이 걸리는 것 같지만, 중요한 요소들을 초반에 분명하게 정리하면 오히려 토론 시간을 단축할 수 있습니다. 의사결정의 흐름을 잘 만들어보세요. 
그리고, 모든 프로세스는 구성원의 조언과 함께 만들어갈 수 있습니다. 
...
*   [빠띠 그룹스](http://parti.xyz) (커뮤니티 플랫폼) 
    *   한줄 소개
...
*   채팅 / 메신저 
    *   한줄 소개
        *   실시간으로 사람들과 소통할 수 있는 도구입니다. 
        *   긴급하거나 간단한 의제에 대해 쉽고 빠르게 의사결정할 수 있습니다. 다만, 정보가 기록되어 모두에게 공유되기 보단, 특정인물에 집중되거나 모두에게 공유되지 않을 가능성이 높습니다. 의사결정한 내용이 쉽게 휘발되어 버립니다.
    *   팁
